...
layout = dbc.Container(
    [
        ...
        dbc.Row([
            dbc.Col([
                dbc.Card([
                    ...
                    dbc.CardBody(html.P('82%', className="card-text", style={'color': '#3b6cc5', 'font-size': '30px', 'font-weight': 'bold', 'text-align': 'center'
                                                                                     })),
        ...
        dbc.Row([
            dbc.Col(html.Img(src='data:image/png;base64,{}'.format(accuracy_graph1), alt="Model Accuracy", style={'height': '250px', 'width': '350px','marginBottom': '20px', 'marginLeft':"10px"}), width=6),
            dbc.Col(html.Img(src='data:image/png;base64,{}'.format(accuracy_graph2), alt="Model Accuracy",style={'height': '250px', 'width': '350px', 'marginBottom': '20px'}), width=6),
