...
layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            ...
            style={"width": "550px", "display": "inline-block", "margin-left":"60px"},optionHeight=30,)],
    ...
    dbc.Row([
        dbc.Col([
            ...
            style={"height": "420px", 'width':'820px', 'margin-left':'50px'})
        ]),
    ]),
...
def plot_logon_attempts(user):
    ...
    fig = plot_graph(df, 'date', 'Logon attempts',
                     f"Count of Logon attempts per day of user {user[0:7]}")
    return fig
...
def plot_logon_graphs(user):
    ...
    fig = plot_graph(df, 'date', 'after_hour_logon',
                     f'Count of after hour Logons of user {user[0:7]}')
    return fig